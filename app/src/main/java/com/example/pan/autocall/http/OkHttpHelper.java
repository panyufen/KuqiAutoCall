...
import com.example.pan.autocall.http.event.ResEvent;
...
public class OkHttpHelper {
    ...
    public static String BASE_URL = "https://raw.githubusercontent.com/panyufen/panyufen.github.io/master";
...
//                LogUtils.i("fieldName " + fieldName + " " + Modifier.toString(field.getModifiers()) + " " + field.getType().getSimpleName());
            ...
            if (httpMethodType == HttpMethodType.GET || reqFields.size() == 0) {
                ...
                Logger.i(String.format("NetStart: GET %n%s", requestUrl));
            } else {
                ...
                Logger.i(String.format("NetStart: POST %s%n%s", requestUrl, new Gson().toJson(reqBean)));
            }
            ...
            call.enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    ...
                    Logger.i(String.format("NetResponse: %s in %.1fms requestFailed", BASE_URL + reqBean.getPath(), ((t2 - t1) / 1e6d)));
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    Logger.i(String.format("NetResponse: %s in %.1fms %n%s", BASE_URL + reqBean.getPath(), ((t2 - t1) / 1e6d), new Gson().toJson(responseBean)));
                    EventBus.getDefault().post(resultResEvent);
                }
            });
            return call;
